...
## [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#what-you%E2%80%99ll-build)  What You’ll Build
...
## [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#prerequisites)  Prerequisites
...
[Navigate to header](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook#)
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#install-ai-sdk-packages)  Install AI SDK Packages
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#install-ai-elements)  Install AI Elements
...
This sets up AI Elements in your project, including conversation components, message displays, prompt inputs, and tool call visualizations.Documentation: [ai-sdk.dev/elements/overview](https://ai-sdk.dev/elements/overview).

### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#install-openai-provider)  Install OpenAI Provider
...
![AI research assistant chatbot interface showing real-time web scraping with Firecrawl and conversational responses powered by OpenAI](https://mintcdn.com/firecrawl/GKat0bF5SiRAHSEa/images/guides/cookbooks/ai-sdk-cookbook/firecrawl-ai-sdk-chatbot.gif?s=cfcbad69aa3f087a474414c0763a260b)
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#understanding-the-frontend)  Understanding the Frontend
...
Open [localhost:3000](http://localhost:3000/) in your browser and test the basic chat functionality. The assistant should respond to messages, but won’t have web scraping or search capabilities yet.![Basic AI chatbot without web scraping capabilities](https://mintcdn.com/firecrawl/GKat0bF5SiRAHSEa/images/guides/cookbooks/ai-sdk-cookbook/simple-ai-sdk-chatbot.gif?s=dd40938ec93fd0ad13568d2825d7552d)
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#install-firecrawl-sdk)  Install Firecrawl SDK
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#create-the-tools-file)  Create the Tools File
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#understanding-the-tools)  Understanding the Tools
...
![AI chatbot with active Firecrawl tools](https://mintcdn.com/firecrawl/GKat0bF5SiRAHSEa/images/guides/cookbooks/ai-sdk-cookbook/active-firecrawl-tools-ai-sdk.gif?s=015de571c2352a0cf6eb70ddb2eaec64)Open [localhost:3000](http://localhost:3000/) and test the enhanced assistant:
...
## [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#how-it-works)  How It Works

### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#message-flow)  Message Flow
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#tool-calling-process)  Tool Calling Process
...
## [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#key-features)  Key Features

### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#model-selection)  Model Selection
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#web-search-toggle)  Web Search Toggle
...
## [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#customization-ideas)  Customization Ideas

### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#add-more-tools)  Add More Tools
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#change-the-ai-model)  Change the AI Model
...
### [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#customize-the-ui)  Customize the UI
...
## [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#best-practices)  Best Practices
...
## [​](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook\#related-resources)  Related Resources

[**AI SDK Documentation** \\
\\
Explore the AI SDK for building AI-powered applications with streaming, tool\\
calling, and multi-provider support.](https://ai-sdk.dev/docs)

[**AI Elements Components** \\
\\
Pre-built UI components for AI applications built on shadcn/ui.](https://ai-sdk.dev/elements/overview)

[Suggest edits](https://github.com/firecrawl/firecrawl-docs/edit/main/developer-guides/cookbooks/ai-research-assistant-cookbook.mdx) [Raise issue](https://github.com/firecrawl/firecrawl-docs/issues/new?title=Issue%20on%20docs&body=Path:%20/developer-guides/cookbooks/ai-research-assistant-cookbook)

[Mastra\\
\\
Previous](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/mastra) [Building a Brand Style Guide Generator with Firecrawl\\
\\
Next](https://docs.firecrawl.dev/developer-guides/cookbooks/brand-style-guide-generator-cookbook)
