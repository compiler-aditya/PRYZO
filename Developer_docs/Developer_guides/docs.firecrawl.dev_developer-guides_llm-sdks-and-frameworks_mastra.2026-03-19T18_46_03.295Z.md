...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/mastra\#setup)  Setup
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/mastra\#multi-step-workflow)  Multi-Step Workflow
...
[Suggest edits](https://github.com/firecrawl/firecrawl-docs/edit/main/developer-guides/llm-sdks-and-frameworks/mastra.mdx) [Raise issue](https://github.com/firecrawl/firecrawl-docs/issues/new?title=Issue%20on%20docs&body=Path:%20/developer-guides/llm-sdks-and-frameworks/mastra)

[LlamaIndex\\
\\
Previous](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/llamaindex) [Building an AI Research Assistant with Firecrawl and AI SDK\\
\\
Next](https://docs.firecrawl.dev/developer-guides/cookbooks/ai-research-assistant-cookbook)
