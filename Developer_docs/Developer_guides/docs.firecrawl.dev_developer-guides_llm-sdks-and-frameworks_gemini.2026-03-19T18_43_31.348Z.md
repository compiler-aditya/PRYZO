...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/gemini\#setup)  Setup
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/gemini\#scrape-+-summarize)  Scrape + Summarize
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/gemini\#content-analysis)  Content Analysis
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/gemini\#structured-extraction)  Structured Extraction
...
[Suggest edits](https://github.com/firecrawl/firecrawl-docs/edit/main/developer-guides/llm-sdks-and-frameworks/gemini.mdx) [Raise issue](https://github.com/firecrawl/firecrawl-docs/issues/new?title=Issue%20on%20docs&body=Path:%20/developer-guides/llm-sdks-and-frameworks/gemini)

[Anthropic\\
\\
Previous](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/anthropic) [Agent Development Kit (ADK)\\
\\
Next](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk)
