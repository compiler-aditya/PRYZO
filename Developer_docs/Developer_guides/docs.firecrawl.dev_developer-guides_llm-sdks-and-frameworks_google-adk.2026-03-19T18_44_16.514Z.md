...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#overview)  Overview
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#features)  Features
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#prerequisites)  Prerequisites

- Obtain an API key for Firecrawl from [firecrawl.dev](https://firecrawl.dev/)
- Install Google ADK

## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#setup)  Setup
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#available-tools)  Available Tools
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#configuration)  Configuration

### [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#required-configuration)  Required Configuration
...
### [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#optional-configuration)  Optional Configuration
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#example-web-research-agent)  Example: Web Research Agent
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#best-practices)  Best Practices

1. **Use the right tool for the job**:   - `firecrawl_search` when you need to find relevant pages first
...
## [​](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/google-adk\#related-resources)  Related Resources
...
[Suggest edits](https://github.com/firecrawl/firecrawl-docs/edit/main/developer-guides/llm-sdks-and-frameworks/google-adk.mdx) [Raise issue](https://github.com/firecrawl/firecrawl-docs/issues/new?title=Issue%20on%20docs&body=Path:%20/developer-guides/llm-sdks-and-frameworks/google-adk)

[Gemini\\
\\
Previous](https://docs.firecrawl.dev/developer-guides/llm-sdks-and-frameworks/gemini) [Vercel AI SDK\\
\\
