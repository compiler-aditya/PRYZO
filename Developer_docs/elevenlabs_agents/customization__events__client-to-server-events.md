<!-- Source: https://elevenlabs.io/docs/eleven-agents/customization/events/client-to-server-events -->
...
events](https://elevenlabs.io/docs/agents-platform/customization/events/client-events) documentation.
...
documentation](https://elevenlabs.io/docs/agents-platform/libraries/python).
