...
ElevenLabs](https://elevenlabs.io/docs/agents-platform/libraries/python).
...
parameters, and examples.](https://elevenlabs.io/docs/agents-platform/api-reference/eleven-agents/websocket)
...
[1](https://elevenlabs.io/docs/eleven-agents/libraries/web-sockets#install-required-dependencies)
...
[2](https://elevenlabs.io/docs/eleven-agents/libraries/web-sockets#create-websocket-types)
...
[3](https://elevenlabs.io/docs/eleven-agents/libraries/web-sockets#create-websocket-hook)
...
[4](https://elevenlabs.io/docs/eleven-agents/libraries/web-sockets#create-the-conversation-component)
...
- [ElevenLabs Agents SDKs](https://elevenlabs.io/docs/agents-platform/libraries/python)
