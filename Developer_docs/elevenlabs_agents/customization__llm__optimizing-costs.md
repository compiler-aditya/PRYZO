...
page](https://elevenlabs.io/docs/agents-platform/overview#pricing-during-silent-periods) for more details.
...
- **Efficient RAG**:
  - RAG reduces input tokens by providing the LLM with only relevant snippets from your [Knowledge Base](https://elevenlabs.io/docs/agents-platform/customization/knowledge-base), instead of including extensive data in the prompt.
  ...
  - Learn more about implementing [RAG](https://elevenlabs.io/docs/agents-platform/customization/knowledge-base/rag).
- **Context size**:
  - Ensure your [Knowledge Base](https://elevenlabs.io/docs/agents-platform/customization/knowledge-base) contains accurate, up-to-date, and relevant information.
...
Using [Server Tools](https://elevenlabs.io/docs/agents-platform/customization/tools/server-tools) allows LLMs to delegate tasks to external APIs or custom code, which can be more cost-effective.
